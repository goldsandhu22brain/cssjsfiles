...
function MeasureConnectionSpeed() {
    ...
    function showResults() {
        ...
        if (speedMbps >= 1.0) {
            $('#imgband').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/tick.png');
            ...
            $('#imgband').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/unchecked.png');
...
function onDetectRTCLoaded() {
   var name = DetectRTC.osName;
    ...
    if (name == 'Windows' || name.toUpperCase().indexOf('MAC')>=0) {
        $('#imgos').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/tick.png');
        $('#divos').addClass('stepgreen');
    }
    else {
        $('#imgos').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/unchecked.png');
        $('#divos').removeClass('stepgreen');
        $('#divos').addClass('stepred');
        Isvalid = false;
    }
    if (DetectRTC.browser.isChrome) {
        $('#imgbrowser').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/tick.png');
        $('#divbrowser').addClass('stepgreen');
    }
    else {
        $('#imgbrowser').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/unchecked.png');
    ...
    if (DetectRTC.hasMicrophone) {
        $('#imgmicro').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/tick.png');
        $('#divmicro').addClass('stepgreen');
    }
    else {
        $('#imgmicro').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/unchecked.png');
    ...
    if (DetectRTC.isWebRTCSupported) {
        $('#imgwebrtc').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/tick.png');
        $('#divwebrtc').addClass('stepgreen');
    }
    else {
        $('#imgwebrtc').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/unchecked.png');
    ...
    if (DetectRTC.hasWebcam) {
        $('#imgcamera').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/tick.png');
        $('#divcamera').addClass('stepgreen');
    }
    else {
        $('#imgcamera').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/unchecked.png');
        $('#divcamera').removeClass('stepgreen');
        $('#divcamera').addClass('stepred');
        Isvalid = false;
    }
    if (DetectRTC.isWebSocketsSupported) {
        $('#imgport').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/tick.png');
        $('#divport').addClass('stepgreen');
    }
    else {
        $('#imgport').attr('src', 'https://mediacdn.brainmeasures.com/dist/img/System/unchecked.png');
